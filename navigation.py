...
if navigation() == "home":
    ...
    st.text("                 ")
    st.text("                 ")
    a = " This project focuses on developing a credit card fraud detection system by combining Mahalanobis Distance-based hybrid sampling with the Random Forest algorithm. The Mahalanobis Distance is used to identify outliers and anomalies in the data, improving the detection of fraudulent activities. By integrating hybrid sampling techniques with the powerful Random Forest classifier, the system aims to enhance prediction accuracy, reduce class imbalance, and provide an effective solution for real-time fraud detection."
